  ...
  return (
    <Container>
      <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
        <Typography variant="h4">Noise Cancellation</Typography>
      ...
      <Dialog open={open} onClose={handleClose} sx={{ width: '100vw' }}>
        <Box width="30vw" p={2} display="flex" flexDirection="column" gap={2}>
          <Box display="flex" alignItems="center" justifyContent="space-between">
            <Typography variant="h5">Add New Noise Cancellation</Typography>
            <Close
              sx={{ cursor: 'pointer' }}
              onClick={() => {
                handleClose();
          ...
          <TextField
            ...
            height="20px"
          />
          <Button width="90%" variant="contained" color="primary">
            Add
          </Button>
        </Box>
      </Dialog>
